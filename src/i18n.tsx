...
const en: Record<string, string> = {
  ...
  "login.mfaSub": "Enter the 6-digit code sent to your registered email.",
  "login.demoCode": "Mail service not connected · demo code",
  "login.otpSent": "Verification code sent to your email",
  "login.otpLinkHint": "No 6-digit code in the email? Click the link inside it instead — it returns you here and completes this step automatically.",
  "login.otpSendFail": "Email delivery failed — using the offline demo channel",
  ...
  "login.f3v": "Biometric match · never stored as an image",
  "login.stepN": "Step",
  "login.ofN": "of",
...
const hi: Record<string, string> = {
  ...
  "login.mfaSub": "आपके पंजीकृत ईमेल पर भेजा गया 6 अंकों का कोड दर्ज करें।",
