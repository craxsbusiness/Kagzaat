...
const en: Record<string, string> = {
  ...
  "login.stepN": "Step",
  "login.ofN": "of",
  "login.bioKicker": "Factor 3 · something you are",
  "login.bioTitle": "Fingerprint scan",
  "login.bioSub": "Press and hold the sensor until the scan completes. This is the third and final factor.",
...
const hi: Record<string, string> = {
  ...
  "login.stepN": "चरण",
  "login.ofN": "/",
  "login.bioKicker": "कारक 3 · आपकी पहचान",
  "login.bioTitle": "फ़िंगरप्रिंट स्कैन",
  "login.bioSub": "स्कैन पूरा होने तक सेंसर दबाकर रखें। यह तीसरा और अंतिम चरण है।",
